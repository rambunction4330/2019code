...
/* our accumulated error times I gain. If you want the robot to creep up then pass a nonzero Igain */
        pid ->
        outBeforRmp += PID_Mux_Unsigned(pid->iAccum, slot->I)
    }
...
/* arm for next pass */
        { pid ->
            prevErr = err /* save the prev error for D */
            pid->notFirst = 1 /* already serviced first pass */
        }
/* if we are using one-direction sensor, only allow throttle in one dir.
217-8080 TALON SRX Software Reference Manual 2/11/2017
Cross The Road Electronics Page 140 2/11/2017
